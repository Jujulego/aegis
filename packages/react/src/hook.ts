import { AegisList, AegisUnknownItem } from '@jujulego/aegis';
...
// Builders
export const $hook = {
  item<A extends unknown[], I extends AegisUnknownItem<any>>(fetcher: (...args: A) => I) {
  ...
  list<A extends unknown[], L extends AegisList<any>>(fetcher: (...args: A) => L) {
